...
一个面向 Codex / ChatGPT 的实用写作规范 skill，用于起草、诊断和改写中文与英文的学术、分析型和 AI 辅助文本。

核心原则来自公开小红书笔记中提到的「不迂回立论 / No negative framing」：先说明事物是什么，再说明它不是什么。除非反面框架能真正帮助读者理解，否则不要把「不是……而是」或 `not X but rather Y` 当成默认立论方式。
...
```text
Use $writing-standards to diagnose the argument, evidence, paragraph logic, and AI texture of this draft.
```
